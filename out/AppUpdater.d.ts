...
import { Logger, ResolvedUpdateFileInfo, UpdateCheckResult, UpdateDownloadedEvent, UpdaterSignal } from "./main";
...
export declare abstract class AppUpdater extends EventEmitter {
    ...
    getUpdateInfoAndProvider(): Promise<UpdateInfoAndProvider>;
     ...
     * @internal
     */
    _testOnlyOptions: TestOnlyUpdaterOptions | null;
    private getOrCreateDownloadHelper;
    getAppSupportCacheDir(): string;
...
export declare function emitDownloadProgress(DOWNLOAD_PROGRESS: string, arg1: {
    progress: string;
}): void;
/** @private */
