...
Object.defineProperty(exports, "generateZipandBlockmap", {
  enumerable: true,
  get: function () {
    return _generateZipandBlockmap().generateZipandBlockmap;
  }
});
...
function _generateZipandBlockmap() {
  const data = require("./generateZipandBlockmap");

  _generateZipandBlockmap = function () {
    return data;
  };
